 ...
 * @author Yuedong Li
 */
public class VCycleViewPager extends Fragment implements OnPageChangeListener, View.OnTouchListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
         view = LayoutInflater.from(getActivity()).inflate(me.codeboy.android.cycleviewpager.R.layout
                .cycleviewpager_viewpager_fragment, null);

        viewPager = (BaseViewPager) view.findViewById(me.codeboy.android.cycleviewpager.R.id
                .viewPager);

        viewPager.setOnTouchListener(this);
        indicatorLayout = (LinearLayout) view.findViewById(me.codeboy.android.cycleviewpager.R.id.viewpagerIndicatorLayout);

        viewPagerFragmentLayout = (FrameLayout) view.findViewById(me.codeboy.android.cycleviewpager.R.id.viewPagerFragmentLayout);
        viewPagerDefaultBg = (LinearLayout) view.findViewById(me.codeboy.android.cycleviewpager.R.id.viewPagerDefaultBg);
    ...
    public VCycleViewPager.onViewCreatedListener getOnViewCreatedListener() {
        return onViewCreatedListener;
    }

    public void setOnViewCreatedListener(VCycleViewPager.onViewCreatedListener onViewCreatedListener) {
...
//            viewPagerFragmentLayout.setVisibility(View.GONE);
        ...
        for (int i = 0; i < indicators.length; i++) {
            ...
            indicators[i] = (TextView) view.findViewById(me.codeboy.android.cycleviewpager.R.id.indicator);
     ...
     * 设置指示器布局
     */
    public void setIndicatorParams(RelativeLayout.LayoutParams params) {
    ...
    private void setIndicator(int selectedPosition) {
        for (int i = 0; i < indicators.length; i++) {
            indicators[i].setBackgroundResource(R.mipmap.lobby_dot2);
        }
        if (indicators.length > selectedPosition) {
            indicators[selectedPosition].setBackgroundResource(R.mipmap.lobby_dot1);
        }
    }
    ...
    public void setViewPagerParams(RelativeLayout.LayoutParams params) {
