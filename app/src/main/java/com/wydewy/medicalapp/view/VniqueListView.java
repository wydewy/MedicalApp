...
//					&& scrollState == SCROLL_STATE_TOUCH_SCROLL) {
	...
	private void reflashViewByState() {
		...
		case PULL:
			...
			tip.setText(context.getString(R.string.push_to_refresh));
			arrow.clearAnimation();
		...
		case RELESE:
			arrow.setVisibility(View.VISIBLE);
			progress.setVisibility(View.GONE);
			tip.setText(context.getString(R.string.release_to_refresh));
			arrow.clearAnimation();
	...
	public void setHeaderVisibility(boolean v){
		if(v){
	...
	public void setFooterVisibility(boolean v){
		if(v){
